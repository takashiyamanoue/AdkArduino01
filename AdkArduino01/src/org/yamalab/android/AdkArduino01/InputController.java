...
implements OnClickListener
{
	...
	AdkArduinoActivity mHostActivity;
	...
	InputController(AdkArduinoActivity hostActivity) {
		super(hostActivity);
		Log.d(TAG,"InputController");
		mHostActivity=hostActivity;
		/* */
		mCommandView = (EditText) findViewById(R.id.input_command_text);
//		mAdk2WikiView = (EditText) findViewById(R.id.input_adk_to_wiki_area);
		...
		mToTwitterButton = (View)findViewById(R.id.label_to_twitter);
